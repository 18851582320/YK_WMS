...
public class ScheduleUtils {
   ...
   // private static final Logger LOG = LoggerFactory.getLogger(ScheduleUtils.class);
	...
	public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) throws Exception {
    	//任务执行类
		Class<? extends Job> jobClass =(Class<? extends Job>) Class.forName (scheduleJob.getTimedTaskClass());
    	createScheduleJob(scheduler, scheduleJob.getTimedTaskName(), scheduleJob.getTimedTaskType(),
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) throws SchedulerException {
        updateScheduleJob(scheduler, scheduleJob.getTimedTaskName(), scheduleJob.getTimedTaskType(),
