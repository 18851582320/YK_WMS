					...
					<table>
						 ...
						 <tr style="height: 30px">
						 	...
						 	<td style="width: 180px;">
						 		<select id="PARENT_ID"  class="easyui-combogrid" editable="false" name="PARENT_ID" style="width: 154px;height: 26px;"   
							        data-options="    
							            required:false,
							            panelWidth:260,
							            required:false,        
							            ...
							            columns:[[    
							                {field:'DEPARTMENT_ID',title:'流水号',width:60,hidden:true},    
