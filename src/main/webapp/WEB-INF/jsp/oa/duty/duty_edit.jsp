...
<body class="addEditDivBody">
	<div class="addEditDiv">
		<div class="">
			<form action="duty/${method}.do" name="dutyForm" id="dutyForm" method="post">
				...
				<input type="hidden" name="dutyId" id="dutyId" value="${pd.dutyId}"/>
				<div id="saveEditCenter" class="saveEditCenter" style="height: 230px;">
					<table>
						<tr style="height: 5px"/>
						 <tr style="height: 30px">
						 	<td style="width: 90px;text-align: right;">职务编码：</td>
						 	<td style="width: 180px;">
						 			<c:choose>
						 			<c:when test="${pd.dutyId == null}">
						 				<input class="easyui-textbox" type="text" id="dutyCode" editable="${codeRuleType eq 1?true:false}"  name="dutyCode" value="${code}" prompt="" data-options="required:true"  title="编码">
						 			</c:when>
						 			<c:otherwise>
						 				<input class="easyui-textbox" type="text" id="dutyCode" editable="false"  name="dutyCode" value="${pd.dutyCode}" prompt="" data-options="required:true"  title="职务编码">
						 			</c:otherwise>
						 		</c:choose>
						 	</td>
						 	<td style="width: 5px;">&nbsp;</td>
						 	<td style="width: 90px;text-align: right;">职务名称：</td>
						 	<td style="width: 180px;">
						 		<input class="easyui-textbox" type="text" name="dutyName" value="${pd.dutyName}" prompt="" data-options="required:true"  title="职务名称">
						 	</td>
						 </tr>
						 <tr style="height: 5px"/>
						 <tr style="height: 30px">
						 ...
						 <tr style="height: 30px">
						  ...
						  <tr style="height: 70px">
						 	...
						 	<td style="width: 450px;" colspan="4">
						 		<input class="easyui-textbox" type="text" name="dutyMemo" value="${pd.dutyMemo}" style="width: 430px;height: 70px;" prompt="" multiline="true" data-options="required:false"  title="备注">
		...
		$("#dutyForm").form("submit",{
			...
			success:function(data){
				...
				if("success"==data.result){
					...
					getFormCodeByRule("OA_duty","dutyCode","dutyCode","codeRuleType");
				}else{
